    ...
    <div>
      <div>
        <h3 className="text-[20px] leading-[30px]  text-headingColor font-semibold flex      items-center gap-2">
          About of
          <span className="text-[#1cb8c3] font-bold text-[24px] leading-9">
            {name}
          </span>
        </h3>
      ...
      <div className="mt-12">
        ...
        <ul className="pt-4 md:p-5">
          ...
          {qualifications?.map((item,index)=> <li key={index} className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]">
            <div>
              <span className="text-[#1CB8C3] text-[15px] leading-6 font-semibold">
      ...
      <div className="mt-12">
        ...
        <ul className="grid sm:grid-cols-2 pt-4 md:p-5 gap-[30px]">
